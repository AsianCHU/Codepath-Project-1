...
class LetterCell: UICollectionViewCell {
  ...
  func set(style: LetterCellStyle) {
    // START YOUR CODE HERE
      if style == LetterCellStyle.initial{
          contentView.backgroundColor = UIColor.black
          contentView.layer.borderColor = UIColor.gray.cgColor
      }
      if style == LetterCellStyle.incorrect{
          contentView.backgroundColor = UIColor(red: 0.23, green: 0.23, blue: 0.25, alpha: 1)
          contentView.layer.borderColor = UIColor(red: 0.23, green: 0.23, blue: 0.25, alpha: 1).cgColor
      }
      if style == LetterCellStyle.correctLetterOnly{
          contentView.backgroundColor = UIColor(red: 0.69, green: 0.63, blue: 0.3, alpha: 1)
          contentView.layer.borderColor = UIColor(red: 0.69, green: 0.63, blue: 0.3, alpha: 1).cgColor
      }
      if style == LetterCellStyle.correctLetterAndPosition{
          contentView.backgroundColor = UIColor(red: 0.38, green: 0.55, blue: 0.33, alpha: 1)
          contentView.layer.borderColor = UIColor(red: 0.38, green: 0.55, blue: 0.33, alpha: 1).cgColor
      }
    // END YOUR CODE HERE
  }
}
